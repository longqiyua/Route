...
pub fn build_router(state: SharedState) -> Router {
    ...
    let api_routes = Router::new()
        ...
        .route("/commits/{id}/annotations", get(handlers::repo::annotations_list_handler))
        .route("/commits/{id}/annotations", post(handlers::repo::annotations_create_handler))
        // ---- Branches (basic mode) ----
        ...
        .route("/branches/{name}/switch", post(handlers::branch::switch_handler))
        // ---- Tags (basic mode) ----
        ...
        .route("/tracking/history", get(handlers::tracking::history_handler))
        // ---- AI ----
        ...
        // ---- Extensions ----
        .route("/extensions/skills", get(handlers::extensions::skills_handler))
        .route("/extensions/references", get(handlers::extensions::references_handler))
        // ---- Permission ----
        ...
        .route("/conversations", post(handlers::conversation::create_handler))
        .route("/conversations/{id}", get(handlers::conversation::show_handler))
        .route("/conversations/{id}/messages", post(handlers::conversation::add_message_handler))
        .route("/conversations/{id}/rollback", post(handlers::conversation::rollback_handler))
        .route("/conversations/{id}/archive", post(handlers::conversation::archive_handler))
        .route("/conversations/{id}", delete(handlers::conversation::delete_handler))
        // ---- Sync ----
        ...
        .route("/git/branches/{name}", delete(handlers::git::branch_delete_handler))
        .route("/git/branches/{name}/switch", post(handlers::git::branch_switch_handler))
        .route("/git/remotes", get(handlers::git::remote_list_handler))
        .route("/git/remotes", post(handlers::git::remote_add_handler))
        .route("/git/remotes/{name}", delete(handlers::git::remote_remove_handler))
        ...
        .route("/git/tags/{name}", delete(handlers::git::tag_delete_handler))
        ...
        .route("/git/rebase/abort", post(handlers::git::rebase_abort_handler))
        .route("/git/rebase/continue", post(handlers::git::rebase_continue_handler))
        ...
        .route("/git/push-upstream", post(handlers::git::push_upstream_handler))
        .route("/git/rebase-in-progress", get(handlers::git::rebase_in_progress_handler))
